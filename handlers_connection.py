...
@chat.function(
    "connect_wave",
    "Connect Wave account via credentials.",
    action_type="write",
    chain_callable=True,
...
async def connect_wave(params: ConnectParams, ctx) -> ActionResult[ConnectionRecord]:
    """Connect a new account."""
    client = WaveClient(api_key=params.api_key, base_url=params.base_url)
...
@chat.function(
    "disconnect_wave",
    "Disconnect Wave account.",
    action_type="write",
    chain_callable=True,
    event="wave-connector.disconnect_wave",
    effects=["delete:connection"],
    data_model=DeleteResult
)
async def disconnect_wave(params: ConnectionIdParams, ctx) -> ActionResult[DeleteResult]:
