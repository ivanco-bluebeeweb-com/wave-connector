...
async def list_customers(ctx, params: ListCustomerParams) -> ActionResult[CustomerList]:
    ...
    return ActionResult.success(CustomerList(items=items, total=data.get("total", len(items)), next_cursor=data.get("next_cursor")))
...
async def get_customer(ctx, params: GetCustomerParams) -> ActionResult[CustomerRecord]:
    ...
    return ActionResult.success(CustomerRecord(id=str(data.get("id", params.customer_id)), name=str(data.get("name", "")), status=str(data.get("status", "active")), raw=data))
...
async def create_customer(ctx, params: CreateCustomerParams) -> ActionResult[CustomerRecord]:
    ...
    return ActionResult.success(CustomerRecord(id=str(data.get("id", "")), name=str(data.get("name", params.name)), status="active", raw=data))
...
async def update_customer(ctx, params: UpdateCustomerParams) -> ActionResult[CustomerRecord]:
    ...
    return ActionResult.success(CustomerRecord(id=params.customer_id, name=str(data.get("name", "")), status="updated", raw=data))
...
async def delete_customer(ctx, params: DeleteCustomerParams) -> ActionResult[DeleteResult]:
    ...
    return ActionResult.success(DeleteResult(id=params.customer_id, deleted=ok, message="customer deleted"))
...
async def list_invoices(ctx, params: ListInvoiceParams) -> ActionResult[InvoiceList]:
    ...
    return ActionResult.success(InvoiceList(items=items, total=data.get("total", len(items)), next_cursor=data.get("next_cursor")))
...
async def get_invoice(ctx, params: GetInvoiceParams) -> ActionResult[InvoiceRecord]:
    ...
    return ActionResult.success(InvoiceRecord(id=str(data.get("id", params.invoice_id)), name=str(data.get("name", "")), status=str(data.get("status", "active")), raw=data))
...
async def create_invoice(ctx, params: CreateInvoiceParams) -> ActionResult[InvoiceRecord]:
    ...
    return ActionResult.success(InvoiceRecord(id=str(data.get("id", "")), name=str(data.get("name", params.name)), status="active", raw=data))
...
async def update_invoice(ctx, params: UpdateInvoiceParams) -> ActionResult[InvoiceRecord]:
    ...
    return ActionResult.success(InvoiceRecord(id=params.invoice_id, name=str(data.get("name", "")), status="updated", raw=data))
...
async def delete_invoice(ctx, params: DeleteInvoiceParams) -> ActionResult[DeleteResult]:
    ...
    return ActionResult.success(DeleteResult(id=params.invoice_id, deleted=ok, message="invoice deleted"))
...
async def list_bills(ctx, params: ListBillParams) -> ActionResult[BillList]:
    ...
    return ActionResult.success(BillList(items=items, total=data.get("total", len(items)), next_cursor=data.get("next_cursor")))
...
async def get_bill(ctx, params: GetBillParams) -> ActionResult[BillRecord]:
    ...
    return ActionResult.success(BillRecord(id=str(data.get("id", params.bill_id)), name=str(data.get("name", "")), status=str(data.get("status", "active")), raw=data))
...
async def create_bill(ctx, params: CreateBillParams) -> ActionResult[BillRecord]:
    ...
    return ActionResult.success(BillRecord(id=str(data.get("id", "")), name=str(data.get("name", params.name)), status="active", raw=data))
...
async def update_bill(ctx, params: UpdateBillParams) -> ActionResult[BillRecord]:
    ...
    return ActionResult.success(BillRecord(id=params.bill_id, name=str(data.get("name", "")), status="updated", raw=data))
...
async def delete_bill(ctx, params: DeleteBillParams) -> ActionResult[DeleteResult]:
    ...
    return ActionResult.success(DeleteResult(id=params.bill_id, deleted=ok, message="bill deleted"))
...
async def list_payments(ctx, params: ListPaymentParams) -> ActionResult[PaymentList]:
    ...
    return ActionResult.success(PaymentList(items=items, total=data.get("total", len(items)), next_cursor=data.get("next_cursor")))
...
async def get_payment(ctx, params: GetPaymentParams) -> ActionResult[PaymentRecord]:
    ...
    return ActionResult.success(PaymentRecord(id=str(data.get("id", params.payment_id)), name=str(data.get("name", "")), status=str(data.get("status", "active")), raw=data))
...
async def create_payment(ctx, params: CreatePaymentParams) -> ActionResult[PaymentRecord]:
    ...
    return ActionResult.success(PaymentRecord(id=str(data.get("id", "")), name=str(data.get("name", params.name)), status="active", raw=data))
...
async def update_payment(ctx, params: UpdatePaymentParams) -> ActionResult[PaymentRecord]:
    ...
    return ActionResult.success(PaymentRecord(id=params.payment_id, name=str(data.get("name", "")), status="updated", raw=data))
...
async def delete_payment(ctx, params: DeletePaymentParams) -> ActionResult[DeleteResult]:
    ...
    return ActionResult.success(DeleteResult(id=params.payment_id, deleted=ok, message="payment deleted"))
...
async def list_bank_accounts(ctx, params: ListBankAccountParams) -> ActionResult[BankAccountList]:
    ...
    return ActionResult.success(BankAccountList(items=items, total=data.get("total", len(items)), next_cursor=data.get("next_cursor")))
...
async def get_bank_account(ctx, params: GetBankAccountParams) -> ActionResult[BankAccountRecord]:
    ...
    return ActionResult.success(BankAccountRecord(id=str(data.get("id", params.bank_account_id)), name=str(data.get("name", "")), status=str(data.get("status", "active")), raw=data))
...
async def create_bank_account(ctx, params: CreateBankAccountParams) -> ActionResult[BankAccountRecord]:
    ...
    return ActionResult.success(BankAccountRecord(id=str(data.get("id", "")), name=str(data.get("name", params.name)), status="active", raw=data))
...
async def update_bank_account(ctx, params: UpdateBankAccountParams) -> ActionResult[BankAccountRecord]:
    ...
    return ActionResult.success(BankAccountRecord(id=params.bank_account_id, name=str(data.get("name", "")), status="updated", raw=data))
...
async def delete_bank_account(ctx, params: DeleteBankAccountParams) -> ActionResult[DeleteResult]:
    ...
    return ActionResult.success(DeleteResult(id=params.bank_account_id, deleted=ok, message="bank_account deleted"))
...
async def list_tax_rates(ctx, params: ListTaxRateParams) -> ActionResult[TaxRateList]:
    ...
    return ActionResult.success(TaxRateList(items=items, total=data.get("total", len(items)), next_cursor=data.get("next_cursor")))
...
async def get_tax_rate(ctx, params: GetTaxRateParams) -> ActionResult[TaxRateRecord]:
    ...
    return ActionResult.success(TaxRateRecord(id=str(data.get("id", params.tax_rate_id)), name=str(data.get("name", "")), status=str(data.get("status", "active")), raw=data))
...
async def create_tax_rate(ctx, params: CreateTaxRateParams) -> ActionResult[TaxRateRecord]:
    ...
    return ActionResult.success(TaxRateRecord(id=str(data.get("id", "")), name=str(data.get("name", params.name)), status="active", raw=data))
...
async def update_tax_rate(ctx, params: UpdateTaxRateParams) -> ActionResult[TaxRateRecord]:
    ...
    return ActionResult.success(TaxRateRecord(id=params.tax_rate_id, name=str(data.get("name", "")), status="updated", raw=data))
...
async def delete_tax_rate(ctx, params: DeleteTaxRateParams) -> ActionResult[DeleteResult]:
    ...
    return ActionResult.success(DeleteResult(id=params.tax_rate_id, deleted=ok, message="tax_rate deleted"))
