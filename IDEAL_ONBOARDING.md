# Wave Connector — Ideal Onboarding

## User outcome
A user connects a Wave account safely, immediately confirms the account that was connected, then starts with a useful read-only operational overview rather than a blank tool list.
